var appAuction = (function (persistenceAuction, persistenceFlights) {
    let renderAuction = (auction) => {
        ...
        persistenceFlights.getFlightByID("flights/" + idFlight, "GET", idFlight, (err, res) => {
            if (err) {
                alert(err)
            } else {
                let flight = res
