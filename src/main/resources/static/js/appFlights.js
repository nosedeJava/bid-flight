    ...
    let showAuction =()=>{
        ...
        persistenceAuction.getAuctions("", (err, res) => {
            if (err) {
                ...
                let listAuctions = res.filter((auction)=>{
                    return auction.ticket.flight.airline.name==="Avianca"
                })
