$(document).ready(function () {
    ...
    let contentWithLoginAirline="<li class='navbar-item'><p style='color: white;font-size:160%;'>Welcome - <span class='airlineName'></span></p></li><li class='nav-item dropdown'><a class='nav-link dropdown-toggle' href='#' id='navbarDropdownMenuLink' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>    <i class='material-icons' style='color:white;'>settings</i></a><div class='dropdown-menu dropdown-menu-right dropdown-default' aria-labelledby='navbarDropdownMenuLink-333'> <a class='dropdown-item' href='flights.html'>Flights</a> <a class='dropdown-item' href='javascript:void(0)' id='btnLogout'>Logout</a></div></li>"
    $.ajax({
